...
|---------------------|------------------|----------------------------------------------------------------------------------------------------|
| Spam Classification | [Spam/Not Spam]  | [Provide the reason for the classification]                                                        |
| Phishing Attempt    | [Phishing/Not Phishing] | [Provide the reason for the classification]                                                        |
| Sentiment Analysis  | [Positive/Negative/Neutral] | [Provide the reason for the sentiment classification]                                               |
...
login_img_base64 = get_img_as_base64("login.png")
background_img_base64 = get_img_as_base64("login.png")
